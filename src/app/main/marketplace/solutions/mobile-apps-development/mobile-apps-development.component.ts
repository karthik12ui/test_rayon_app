...
@Component({
  selector: 'app-mobile-apps-development',
  templateUrl: './mobile-apps-development.component.html',
  styleUrls: ['./mobile-apps-development.component.scss']
})
export class MobileAppsDevelopmentComponent implements OnInit {
  scrollTo:boolean;
  pageContent: any;
  constructor(public rayonsoftSolutionService: SolutionsService, 
    public layoutSharedService :LayoutSharedService) {
    this.pageContent = this.rayonsoftSolutionService.pageContent.mobileAppDev;
    this.scrollTo = false;
  }
